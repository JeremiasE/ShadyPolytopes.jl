...
function optimize_small_projection_sos_model(
    feasibility=true; bound=95//100, maxdegree=3, solver=Clarabel.Optimizer
)
...
function optimize_tiny_sos_model(
    feasibility=true, equation=false; bound=174//100, maxdegree=2, solver=SCS.Optimizer
)
